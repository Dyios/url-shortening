...
export default function Footer({ maxWidth, dat }) {
    const { footerBackground } = useTheme().palette;
    return (
        <Container maxWidth={false} sx={{ backgroundColor: 'footerBackground.main' }}>
                ...
                >
                    <Box sx={{ flexGrow: 0.3 }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="121" height="33">
                            <path fill={footerBackground.contrastText}
